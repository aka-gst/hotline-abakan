 ...
 */
  ...
  function draw(world, view) {
     ...
     */
    /*
     * Поблажка у стен. На узком экране, положенном набок, этаж выше
     * кадра, и при жёстком упоре игрок оказывался прижат к нижней
     * кромке: вниз не видно ничего. Чем больше поблажка, тем ближе он к
     * центру и тем больше показывается за краем этажа — 0.6 найдено на
     * 767×360, где жалоба и возникла.
     */
    const slack = view.centred ? 0.6 : 0;
