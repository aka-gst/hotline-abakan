...
function updateHud(force) {
  ...
  const icon = player.weapon === 'fists'
    ? 'assets/ui/fists.png'
    : `assets/items/${player.weapon}.png`;
  if (ui.weaponIcon) {
...
/* Сцена дублируется в атрибуте на теле страницы: вёрстке нужно знать,
