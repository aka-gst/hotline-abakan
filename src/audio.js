 ...
 *
 * Границу слова через \b здесь ставить нельзя: \b определена через \w,
 * то есть латиницу с цифрами, и после кириллической «о» границы нет ни
 * перед концом строки, ни перед «&». Соседняя игра на этом и стояла:
 * латиница проходила, кириллица нет, и выражение выглядело исправным.
 * Разделители заданы явно — иначе «?тихонько» тоже считалось бы флагом.
 */
export function wantsQuiet(locationText) {
  ...
  /* Три написания: кириллицей, латиницей и транслитом — соглашение общее
     на все игры, и один адрес должен глушить любую из них. */
